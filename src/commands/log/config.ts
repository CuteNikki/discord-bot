                      ...
                      { guildId },
                      {
                        $set: {
                          ['log.events']: {
                            ...
                            emojiDelete: true,
                            emojiUpdate: true,
                            guildAuditLogEntryCreate: config.log.events.guildAuditLogEntryCreate,
                            guildBanAdd: true,
                            guildBanRemove: true,
                            guildMemberAdd: true,
                            ...
                            threadMembersUpdate: config.log.events.threadMembersUpdate,
                      ...
                      { guildId },
                      {
                        $set: {
                          ['log.events']: {
                            ...
                            channelPinsUpdate: config.log.events.channelPinsUpdate,
                            ...
                            webhooksUpdate: config.log.events.webhooksUpdate,
                          },
                        },
                      },
                      { new: true, upsert: true }
